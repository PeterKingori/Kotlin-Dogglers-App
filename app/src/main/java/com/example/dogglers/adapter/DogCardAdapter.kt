...
class DogCardAdapter(
    ...
    /**
     * Initialize view elements. Provide a reference to the views for each data item.
     */
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogCardViewHolder {
        ...
        val itemLayoutType = if (layout == Layout.GRID) {
        ...
        val adapterLayout = LayoutInflater.from(parent.context)
            .inflate(itemLayoutType, parent, false)
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        // This resources variable is used to reference string resources without
        // using context?.resources every time.
